...
//                    }
                    ...
                    lifecycleScope.launch {
                        withContext(Dispatchers.Default) {
                            Log.i("CameraFragment", "Movimiento: $movimientoEditado")
                            movimientoEditado.id = movimiento!!.id
                            //OJO
                            movimientoEditado.imagen64 =
                                bitmapToBase64(imageView.drawable.toBitmap())
                            //
                            movimientoDao.update(movimientoEditado)
                        }
                    }
